...
public:
    ...
    void run() {
        ...
        while (true) {
            try {
                cout << "How many activities do you want to do today? (1-9): ";
                cin >> numActivities;
                if (cin.fail()) {
                    cin.clear();
                    cin.ignore(1000, '\n');
                ...
                if (numActivities < 1 || numActivities > 9) {
                    throw out_of_range("Number must be between 1 and 9.");
                }
                break;
        ...
        for (int i = 1; i <= numActivities; i++) {
            ...
            cout << "----------------------------------------" << endl;
            cout << "  1. Study      6. Socializing" << endl;
            cout << "  2. Sleep      7. Meditation" << endl;
            cout << "  3. Exercise   8. Cooking" << endl;
            cout << "  4. Relax      9. Reading" << endl;
            cout << "  5. Gaming" << endl;
            cout << "----------------------------------------" << endl;
            ...
            while (true) {
                try {
                    ...
                    if (choice < 1 || choice > 9) {
                        throw out_of_range("Choice must be between 1 and 9.");
                    }
                    break;
                } catch (invalid_argument& e) {
                    cout << "  [Error] " << e.what() << endl;
            ...
            else if (choice == 8) { Cooking c; c.apply(stats); activityLog.push_back("Cooking"); }
            else if (choice == 9) { Reading rd; rd.apply(stats); activityLog.push_back("Reading"); }
