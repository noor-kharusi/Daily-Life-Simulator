...
public:
    ...
    // Operator overloading - adds two Stats objects together
...
public:
    ...
    // Destructor
    ~Activity() {
        cout << "Activity destroyed." << endl;
    }

    // Pure virtual function - forces each derived class to define apply()
...
public:
    ...
    // Destructor
    ~DaySimulator() {
        cout << "DaySimulator destroyed." << endl;
    }
